...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.19-bioc-mac-arm64"
...
# Control propagation:
export BBS_OUTGOING_MAP="mac.binary.big-sur-arm64:kjohnson3/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="kjohnson3:bin"
