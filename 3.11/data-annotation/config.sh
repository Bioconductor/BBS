#!/bin/bash
# ====================================================================================
# Settings shared by all the Unix nodes involved in the 3.11-data-annotation subbuilds
# ====================================================================================


export BBS_SUBBUILDS="data-annotation"
...
export BBS_BIOC_MANIFEST_GIT_BRANCH="RELEASE_3_11"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.11-data-annotation/MEAT0"
