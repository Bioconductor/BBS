...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.5-data-experiment"
export BBS_R_HOME="/home/biocbuild/bbs-2.5-bioc/R"
export BBS_NB_CPU=2
...
export BBS_REPORT_NODES="wilson2 gewurz:bin pitt:bin pelham:bin"
