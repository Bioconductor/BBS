...
::   E:\biocbld\bbs-2.5-bioc\R\bin\R
:: to build binary packages from the source packages located in
::   E:\biocbld\bbs-2.5-data-annotation\src-pkgs
...
FOR %%a IN (..\src-pkgs\*.tar.gz) DO E:\biocbld\bbs-2.5-bioc\R\bin\R CMD INSTALL --build --library=..\Rlib %%a
