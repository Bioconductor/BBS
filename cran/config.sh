...
export BBS_RSH_CMD="$BBS_SSH_CMD -qi $BBS_RSAKEY -o StrictHostKeyChecking=no"
export BBS_RSYNC_CMD="$BBS_RSYNC_CMD -rl --delete --exclude='.svn'"
export BBS_RSYNC_RSH_CMD="$BBS_RSYNC_CMD -e '$BBS_RSH_CMD'"
...
export BBS_STAGE2_R_SCRIPT="$BBS_HOME/cran/STAGE2.R"
export BBS_NON_TARGET_REPOS_FILE="$BBS_HOME/cran/non_target_repos.txt"
