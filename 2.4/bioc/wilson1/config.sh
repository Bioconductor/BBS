...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.4-bioc"
...
export BBS_REPORT_NODES="wilson1 liverpool:bin pitt:bin pelham:bin"
export BBS_SVNCHANGELOG_URL="http://fgc.lsi.umich.edu/cgi-bin/blosxom3.cgi"
