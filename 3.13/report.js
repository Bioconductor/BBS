...
function toggle(theClass) {
    var fullClass = "TABLE.scard_list TR."+theClass;
    var element = "display";
    var show;
    if(document.getElementById(theClass).checked){
        show = "table-row";
        if(theClass=="ok"){
            changecss("TABLE.scard_list TR.abc", element, "table-row");
        }
    }else{
        show = "none";
        if(theClass=="ok"){
            changecss("TABLE.scard_list TR.abc", element, "none");
        }
    }
    ...
    changecss("TABLE.scard_list TR.warnings.error.timeout", element, "none");
    changecss("TABLE.scard_list TR.warnings.error", element, "none");
    changecss("TABLE.scard_list TR.warnings.timeout", element, "none");
    changecss("TABLE.scard_list TR.error.timeout", element, "none");
    switch(selections)
    {
    case 1:
        changecss("TABLE.scard_list TR.warnings.error", element, "table-row");
        changecss("TABLE.scard_list TR.warnings.timeout", element, "table-row");
        changecss("TABLE.scard_list TR.warnings.error.timeout", element, "table-row");
        break;    
    case 2:
        changecss("TABLE.scard_list TR.warnings.error", element, "table-row");
        changecss("TABLE.scard_list TR.error.timeout", element, "table-row");
        changecss("TABLE.scard_list TR.warnings.error.timeout", element, "table-row");
        break;    
    case 3:
        changecss("TABLE.scard_list TR.warnings.error", element, "table-row");
