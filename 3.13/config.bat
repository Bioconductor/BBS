@rem ====================================================================
@rem Settings shared by all the Windows nodes involved in the 3.13 builds
@rem ====================================================================
...
set BBS_RSYNC_CMD=%BBS_RSYNC_CMD% -r --delete --exclude='.svn' --exclude='.git' --exclude='.git_*'
