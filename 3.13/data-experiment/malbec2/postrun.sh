...
# updateReposPkgs-data-experiment.sh script that we run from the biocadmin
...
$BBS_RSCRIPT_CMD --vanilla -e "source('$BBS_HOME/utils/createPropagationDB.R');createPropagationList('$OUTGOING_DIR', '$PROPAGATE_STATUS_DB', 'data/experiment', '$INTERNAL_REPOS')"
