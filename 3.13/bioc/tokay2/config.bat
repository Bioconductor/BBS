...
@rem jump host ada.dfci.harvard.edu, see BBS_SSH_CMD below).
...
set BBS_SSH_CMD=C:\cygwin\bin\ssh.exe -qi D:\biocbuild\.BBS\id_rsa -o StrictHostKeyChecking=no -J biocbuild@ada.dfci.harvard.edu
