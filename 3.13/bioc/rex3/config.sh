...
export BBS_OUTGOING_MAP="source:rex3/buildsrc win.binary:riesling1/buildbin mac.binary:machv2/buildbin"
...
export BBS_REPORT_NODES="rex3 riesling1:bin tokay2:bin machv2:bin"
