...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo1/buildsrc win.binary:tokay1/buildbin mac.binary:machv2/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo1 tokay1:bin machv2:bin"
