...
# jump host ada.dfci.harvard.edu, see BBS_SSH_CMD below).
...
export BBS_SSH_CMD="/usr/bin/ssh -qi /Users/biocbuild/.BBS/id_rsa -o StrictHostKeyChecking=no -J biocbuild@ada.dfci.harvard.edu"
