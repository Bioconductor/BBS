...
export BBS_FINAL_REPO="file://home/biocadmin/PACKAGES/$BBS_BIOC_VERSION/bioc"
...
export BBS_PUBLISHED_REPORT_RELATIVEURL="checkResults/$BBS_BIOC_VERSION/malbec2/$BBS_BUILDTYPE-LATEST/"
