...
##    REPOS_NAME="Bioconductor 3.10 Packages - Experiment"
##    VIEW_ROOT="$HOME/PACKAGES/3.10"
##    REPOS_ROOT="$VIEW_ROOT/data/experiment"
##    CONTRIB_PATHS="c(source='src/contrib', win.binary='bin/windows/contrib/3.6')"
...
R_SCRIPT="$R_SCRIPT; install.packages('BiocManager', repos='https://cran.rstudio.com')"
...
R_SCRIPT="$R_SCRIPT; manifestFile <- '$MANIFEST_FILE'"
R_SCRIPT="$R_SCRIPT; meatPath <- '$MEAT_PATH'"
...
R_SCRIPT="$R_SCRIPT; genReposControlFiles(reposRoot, contribPaths, manifestFile, meatPath)"
