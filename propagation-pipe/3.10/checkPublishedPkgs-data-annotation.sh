...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.10/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.10/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/3.6/*.zip
bin/macosx/contrib/3.6/*.tgz"
CONTRIB_DIR=" \/.*\/"
