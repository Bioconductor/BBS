...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.12/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.12/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.0/*.zip
bin/macosx/contrib/4.0/*.tgz"
CONTRIB_DIR=" \/.*\/"
