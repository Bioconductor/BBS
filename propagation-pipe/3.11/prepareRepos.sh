...
##    REPOS_NAME="Bioconductor 3.11 Packages - Experiment"
##    VIEW_ROOT="$HOME/PACKAGES/3.11"
...
R_SCRIPT="$R_SCRIPT; meatPath <- '$MEAT0_PATH'"
...
R_SCRIPT="$R_SCRIPT; if ($EXTRACT_MANUALS) extractManuals(reposRoot, contribPaths)"
