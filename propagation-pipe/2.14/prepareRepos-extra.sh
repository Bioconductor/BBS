...
cd "$HOME/manage-BioC-repos/2.14"

. ./config.sh

REPOS_NAME="Bioconductor $BIOC_VERSION Packages - Extra"
REPOS_ROOT="$HOME/PACKAGES/$BIOC_VERSION/extra"
CONTRIB_PATHS="c(source='src/contrib', win.binary='bin/windows/contrib/$R_VERSION', win64.binary='bin/windows64/contrib/$R_VERSION', mac.binary='bin/macosx/contrib/$R_VERSION', mac.binary.mavericks='bin/macosx/mavericks/contrib/$R_VERSION')"
HTML_DIR="extra/html"
