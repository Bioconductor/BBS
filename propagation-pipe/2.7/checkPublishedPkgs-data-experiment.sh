...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.7/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.7/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.12/*.zip bin/macosx/leopard/contrib/2.12/*.tgz"
CONTRIB_DIR=" \/.*\/"
