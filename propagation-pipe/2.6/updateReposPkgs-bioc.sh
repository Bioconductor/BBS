...
echo "Updating repo with packages from gewurz..."
echo "library('buildBioC'); BBSupdateRepos('$BBS_CENTRAL_RDIR/nodes/gewurz', '$WIN64_CONTRIB', 'win64.binary')"| $R --slave
