...
REPOS_NAME="Bioconductor 2.4 Packages - Extra"
REPOS_ROOT="$HOME/PACKAGES/2.4/extra"
CONTRIB_PATHS="c(source='src/contrib', win.binary='bin/windows/contrib/2.9', mac.binary.universal='bin/macosx/universal/contrib/2.9', mac.binary.leopard='bin/macosx/leopard/contrib/2.9')"
