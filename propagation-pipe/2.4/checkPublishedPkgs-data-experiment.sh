...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.4/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.4/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.9/*.zip bin/macosx/universal/contrib/2.9/*.tgz"
CONTRIB_DIR=" \/.*\/"
...
mail "paboyoun@fhcrc.org" -s "Result of $0 on $HOSTNAME" <$MD5SUMS_DIFF
