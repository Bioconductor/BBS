...
CONTRIB_PATHS="c(source='src/contrib', win.binary='bin/windows/contrib/$R_VERSION', win64.binary='bin/windows64/contrib/$R_VERSION', mac.binary.leopard='bin/macosx/leopard/contrib/$R_VERSION')"
HTML_DIR="extra/html"
