...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.3/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.3/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.8/*.zip bin/macosx/universal/contrib/2.8/*.tgz"
CONTRIB_DIR=" \/.*\/"
