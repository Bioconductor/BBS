...
# put-bin-pkgs.sh
#
# Put the "2.1-data-annotation" binary packages on lamb1.
# The binary packages are taken from
#   E:\biocbld\bbs-2.1-data-annotation\bin-pkgs
#
...
SRC_DIR="/cygdrive/e/biocbld/bbs-2.1-data-annotation/bin-pkgs"

DEST_HOST="lamb1"
DEST_USER="biocadmin"
DEST_DIR="PACKAGES/$REPOS_DIR/bin/windows/contrib/2.6"
