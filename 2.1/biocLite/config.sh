#!/bin/bash
# =========================================================================
# Settings shared by all the Unix nodes involved in the 2.1-biocLite builds
# =========================================================================
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-2.1-biocLite/MEAT0"
...
export BBS_BIOC_MANIFEST_FILE="$BBS_HOME/2.1/biocLite/biocLite_2.1.manifest"
