#!/bin/bash
# ===================================================================================
# Settings shared by all the Unix nodes involved in the 3.10-bioc-longtests subbuilds
# ===================================================================================
...
export BBS_BIOC_MANIFEST_GIT_BRANCH="RELEASE_3_10"
export BBS_BIOC_MANIFEST_CLONE_PATH="/home/biocbuild/bbs-3.10-bioc/manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.10-bioc/MEAT0"
