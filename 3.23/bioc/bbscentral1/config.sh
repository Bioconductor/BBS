...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo1/buildsrc mac.binary.big-sur-x86_64:lconway/buildbin mac.binary.big-sur-arm64:kjohnson3/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo1 lconway:buildbin kjohnson3:buildbin kunpeng2"
