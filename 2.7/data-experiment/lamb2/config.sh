...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.7-data-experiment"
export BBS_R_HOME="/home/biocbuild/bbs-2.7-bioc/R"
export BBS_NB_CPU=2
...
export BBS_OUTGOING_MAP="source:lamb2/buildsrc win.binary:gewurz/buildbin mac.binary.leopard:petty/buildbin"
...
export BBS_REPORT_NODES="lamb2 gewurz:bin petty:bin"
