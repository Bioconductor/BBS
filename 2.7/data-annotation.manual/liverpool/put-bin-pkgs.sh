...
# put-bin-pkgs.sh
#
# Put the "2.7-data-annotation" binary packages on lamb2.
# The binary packages are taken from
#   E:\biocbld\bbs-2.7-data-annotation\bin-pkgs
#
...
SRC_DIR="/cygdrive/e/biocbld/bbs-2.7-data-annotation/bin-pkgs"

DEST_HOST="lamb2"
DEST_USER="biocadmin"
DEST_DIR="PACKAGES/$REPOS_DIR/bin/windows/contrib/2.12"
