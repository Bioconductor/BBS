@rem ===========================================================================
@rem Settings shared by all the Windows nodes involved in the 3.7-workflow subbuilds
@rem ===========================================================================
...
set BBS_BIOC_MANIFEST_GIT_BRANCH=RELEASE_3_7
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.7-workflows/MEAT0
...
set BBS_GITLOG_RDIR=/home/biocbuild/public_html/BBS/3.7/workflows/gitlog
