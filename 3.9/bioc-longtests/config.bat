@rem =====================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.9-bioc-longtests subbuilds
@rem =====================================================================================
...
set BBS_BIOC_MANIFEST_CLONE_PATH=/home/biocbuild/bbs-3.9-bioc/manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.9-bioc/MEAT0
...
set BBS_GITLOG_RDIR=/home/biocbuild/public_html/BBS/3.9/bioc/gitlog
