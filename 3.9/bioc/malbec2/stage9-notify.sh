...
# Make sure this script is scheduled to run only after the build report has been created.
# This is because the emails that are sent out have links to the build report and will not
# be useful if those links are broken.
...
# email address:
#
#   $BBS_HOME/BBS-notify.py hpages.on.github@gmail.com
#
