...
export BBS_NB_CPU=12  # 20 cores are available
...
export BBS_OUTGOING_MAP="source:malbec2/buildsrc win.binary:tokay2/buildbin mac.binary.el-capitan:merida2/buildbin"
...
export BBS_REPORT_NODES="malbec2 tokay2:bin merida2:bin celaya2:bin"
