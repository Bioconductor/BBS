@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 2.10-data-experiment builds
@rem ===================================================================================


set BBS_MODE=data-experiment

set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.2.10.manifest
...
@rem Where is it?
set BBS_MEAT0_RHOST=lamb2
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.10-data-experiment/MEAT0
