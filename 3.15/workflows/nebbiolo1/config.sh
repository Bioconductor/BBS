...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.15-workflows"
export BBS_R_HOME="/home/biocbuild/bbs-3.15-bioc/R"
...
export BBS_REPORT_NODES="nebbiolo1 riesling1 merida1"
