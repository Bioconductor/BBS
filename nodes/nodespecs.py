...
allnodes = {
    ...
    'nebbiolo1':   {'OS'      : "Linux (Ubuntu 24.04.4 LTS)",
                    ...
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'nebbiolo2':   {'OS'      : "Linux (Ubuntu 24.04.4 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'teran2':      {'OS'      : "Linux (Ubuntu 24.04.4 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'biocgpu':     {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'kakapo1':     {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'amarone':     {'OS'      : "Linux (Ubuntu 24.04.4 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'kjohnson3':   {'OS'      : "macOS 13.7.7 Ventura",
                    ...
                    'encoding': "utf-8"},
    'lconway':     {'OS'      : "macOS 12.7.6 Monterey",
                    'Arch'    : "x86_64",
