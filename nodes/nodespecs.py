...
allnodes = {
    ...
    'nebbiolo1':   {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'nebbiolo2':   {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'teran2':      {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'biocgpu':     {'OS'      : "Linux (Ubuntu 24.04.2 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'kakapo1':     {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    ...
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    'amarone':     {'OS'      : "Linux (Ubuntu 24.04.3 LTS)",
                    'Arch'    : "x86_64",
                    'Platform': "x86_64-linux-gnu",
                    'pkgType' : "source",
                    'encoding': "utf_8"},
    ...
    'palomino8':   {'OS'      : "Windows Server 2022 Datacenter",
                    ...
                    'pkgType' : "win.binary",
                    'encoding': "iso8859"},
    'kjohnson1':   {'OS'      : "macOS 13.7.5 Ventura",
                    'Arch'    : "arm64",
