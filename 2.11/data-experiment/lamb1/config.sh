...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.11-data-experiment"
export BBS_R_HOME="/home/biocbuild/bbs-2.11-bioc/R"
export BBS_NB_CPU=2
...
export BBS_OUTGOING_MAP="source:lamb1/buildsrc win.binary:moscato1/buildbin mac.binary.leopard:perceval/buildbin"
...
export BBS_REPORT_NODES="lamb1 moscato1:bin perceval:bin"
