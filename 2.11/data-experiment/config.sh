#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 2.11-data-experiment builds
# ================================================================================


export BBS_MODE="data-experiment"

export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.2.11.manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-2.11-data-experiment/MEAT0"
