...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.5-bioc"
...
export BBS_OUTGOING_MAP="source:malbec2/buildsrc win.binary:tokay2/buildbin mac.binary.mavericks:toluca2/buildbin mac.binary.el-capitan:veracruz2/buildbin"
...
export BBS_REPORT_NODES="malbec2 tokay2:bin toluca2:bin veracruz2:bin"
