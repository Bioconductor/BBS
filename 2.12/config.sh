#!/bin/bash
# ================================================================
# Settings shared by all the Unix nodes involved in the 2.12 builds
# ================================================================
