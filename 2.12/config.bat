@rem ===================================================================
@rem Settings shared by all the Windows nodes involved in the 2.12 builds
@rem ===================================================================
