@rem ========================================================================
@rem Settings shared by all the Windows nodes involved in the 2.14-bioc builds
@rem ========================================================================


set BBS_MODE=bioc

set BBS_BIOC_MANIFEST_FILE=bioc_2.14.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.14-bioc/MEAT0
