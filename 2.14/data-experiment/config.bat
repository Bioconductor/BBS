@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 2.14-data-experiment builds
@rem ===================================================================================


set BBS_MODE=data-experiment

set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.2.14.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.14-data-experiment/MEAT0
