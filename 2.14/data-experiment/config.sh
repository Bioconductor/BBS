#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 2.14-data-experiment builds
# ================================================================================
...
# TODO change this:
export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.2.14.manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-2.14-data-experiment/MEAT0"
