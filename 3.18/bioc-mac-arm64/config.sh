#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 3.18-bioc-mac-arm64 builds
# ================================================================================


export BBS_BUILDTYPE="bioc-mac-arm64"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.18-bioc-mac-arm64/MEAT0"
