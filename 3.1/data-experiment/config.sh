#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 3.1-data-experiment builds
# ================================================================================
...
# TODO change this:
export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.3.1.manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.1-data-experiment/MEAT0"
