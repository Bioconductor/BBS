@rem ======================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.8-data-experiment subbuilds
@rem ======================================================================================
...
set BBS_BIOC_MANIFEST_GIT_BRANCH=RELEASE_3_8
...
set BBS_MEAT0_RHOST=malbec1.bioconductor.org
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.8-data-experiment/MEAT0
...
set BBS_GITLOG_RDIR=/home/biocbuild/public_html/BBS/3.8/data-experiment/gitlog
