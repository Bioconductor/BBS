@rem ========================================================================
@rem Settings shared by all the Windows nodes involved in the 1.9-bioc builds
@rem ========================================================================


set BBS_MODE=bioc

set BBS_BIOC_MANIFEST_FILE=bioc_1.9.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-1.9/MEAT0
