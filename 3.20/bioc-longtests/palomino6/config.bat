@rem ======================
@rem Settings for palomino6
@rem ======================


set BBS_DEBUG=0

set BBS_NODE_HOSTNAME=palomino6
set BBS_USER=biocbuild
set BBS_WORK_TOPDIR=C:\Users\biocbuild\bbs-3.20-bioc-longtests
set BBS_R_HOME=C:\Users\biocbuild\bbs-3.20-bioc\R

@rem palomino6 has 32 logical CPUs.
set BBS_NB_CPU=8
