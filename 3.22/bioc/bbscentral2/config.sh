...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo2/buildsrc mac.binary.big-sur-x86_64:merida1/buildbin mac.binary.big-sur-arm64:kjohnson1/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo2 merida1:buildbin kjohnson1:buildbin taishan"
