@rem ====================================================================
@rem Settings shared by all the Windows nodes involved in the 3.14 builds
@rem ====================================================================
...
set BBS_RSYNC_OPTIONS=-r --delete --exclude='.svn' --exclude='.git' --exclude='.github' --exclude='.git_*'
