...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.14-workflows"
...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo2/buildsrc win.binary:riesling1:buildbin mac.binary:machv2/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/workflows"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo2 riesling1:bin machv2:bin"
