@rem ======================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.14-bioc-longtests subbuilds
@rem ======================================================================================
...
set BBS_BIOC_MANIFEST_CLONE_PATH=/home/biocbuild/bbs-3.14-bioc/manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.14-bioc/MEAT0
