...
export BBS_OUTGOING_MAP="source:zin1/buildsrc win.binary:moscato1/buildbin mac.binary.mavericks:morelia/buildbin"
...
export BBS_REPORT_NODES="zin1 moscato1:bin morelia:bin"
