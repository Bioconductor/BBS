...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.23/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.23/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.6/*.zip bin/macosx/big-sur-x86_64/contrib/4.6/*.tgz"
CONTRIB_DIR=" \/.*\/"
