...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.15/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.15/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.2/*.zip bin/macosx/contrib/4.2/*.tgz"
CONTRIB_DIR=" \/.*\/"
