...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.14/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.14/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.1/*.zip
bin/macosx/contrib/4.1/*.tgz"
CONTRIB_DIR=" \/.*\/"
