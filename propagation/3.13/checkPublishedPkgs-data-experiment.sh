...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.13/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.13/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.1/*.zip bin/macosx/contrib/4.1/*.tgz"
CONTRIB_DIR=" \/.*\/"
