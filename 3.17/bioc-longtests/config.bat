@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.17-bioc-longtests builds
@rem ===================================================================================
...
set BBS_BIOC_MANIFEST_GIT_BRANCH=RELEASE_3_17
set BBS_BIOC_MANIFEST_CLONE_PATH=/home/biocbuild/bbs-3.17-bioc/manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.17-bioc/MEAT0
