#!/bin/bash
# =======================================================================
# Settings shared by all the Unix nodes involved in the 3.17-books builds
# =======================================================================
...
export BBS_BIOC_MANIFEST_GIT_BRANCH="RELEASE_3_17"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.17-books/MEAT0"
