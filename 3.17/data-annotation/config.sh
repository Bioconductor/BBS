#!/bin/bash
# =================================================================================
# Settings shared by all the Unix nodes involved in the 3.17-data-annotation builds
# =================================================================================


export BBS_BUILDTYPE="data-annotation"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.17-data-annotation/MEAT0"
