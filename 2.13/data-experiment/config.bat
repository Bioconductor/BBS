@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 2.13-data-experiment builds
@rem ===================================================================================
...
set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.2.13.manifest
...
@rem Where is it?
set BBS_MEAT0_RHOST=zin1
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.13-data-experiment/MEAT0
