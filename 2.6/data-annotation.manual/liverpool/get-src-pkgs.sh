...
# get-src-pkgs.sh
#
# Get the "2.6-data-annotation" source packages from wilson1.
# The retrieved packages are locally stored in
#   E:\biocbld\bbs-2.6-data-annotation\src-pkgs
#
...
DEST_DIR="/cygdrive/e/biocbld/bbs-2.6-data-annotation/src-pkgs"
