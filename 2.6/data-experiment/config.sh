#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 2.6-data-experiment builds
# ================================================================================


export BBS_MODE="data-experiment"

export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.manifest"
...
# Where is it?
export BBS_MEAT0_RHOST="wilson1"
export BBS_MEAT0_RUSER="biocbuild"
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-2.6-data-experiment/MEAT0"
