#!/bin/bash
# =====================================================================
# Settings shared by all the Unix nodes involved in the 2.6-bioc builds
# =====================================================================


export BBS_MODE="bioc"

export BBS_BIOC_MANIFEST_FILE="bioc_2.6.manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-2.6-bioc/MEAT0"
