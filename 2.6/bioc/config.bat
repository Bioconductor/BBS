@rem ========================================================================
@rem Settings shared by all the Windows nodes involved in the 2.6-bioc builds
@rem ========================================================================


set BBS_MODE=bioc

set BBS_BIOC_MANIFEST_FILE=bioc_2.6.manifest
...
@rem Where is it?
set BBS_MEAT0_RHOST=wilson1
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.6-bioc/MEAT0
