#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 3.0-data-experiment builds
# ================================================================================


export BBS_MODE="data-experiment"

export BBS_BIOC_MANIFEST_FILE="bioc-data-experiment.3.0.manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.0-data-experiment/MEAT0"
