@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.0-data-experiment builds
@rem ===================================================================================


set BBS_MODE=data-experiment

set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.3.0.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.0-data-experiment/MEAT0
