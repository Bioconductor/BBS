@rem ========================================================================
@rem Settings shared by all the Windows nodes involved in the 3.0-bioc builds
@rem ========================================================================


set BBS_MODE=bioc

set BBS_BIOC_MANIFEST_FILE=bioc_3.0.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.0-bioc/MEAT0
