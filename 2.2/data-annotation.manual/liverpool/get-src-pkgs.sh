...
# get-src-pkgs.sh
#
# Get the "2.2-data-annotation" source packages from lamb1.
# The retrieved packages are locally stored in
#   E:\biocbld\bbs-2.2-data-annotation\src-pkgs
#
...
DEST_DIR="/cygdrive/e/biocbld/bbs-2.2-data-annotation/src-pkgs"
