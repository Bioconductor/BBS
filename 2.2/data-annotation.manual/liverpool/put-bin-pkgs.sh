...
# put-bin-pkgs.sh
#
# Put the "2.2-data-annotation" binary packages on lamb1.
# The binary packages are taken from
#   E:\biocbld\bbs-2.2-data-annotation\bin-pkgs
#
# Questions/help: hpages@fhcrc.org (ext. 5791)
# Last modified: 2007-04-18

REPOS_LABEL="2.2-data-annotation"
REPOS_DIR="2.2/data/annotation"

SRC_DIR="/cygdrive/e/biocbld/bbs-2.2-data-annotation/bin-pkgs"

DEST_HOST="lamb1"
DEST_USER="biocadmin"
DEST_DIR="PACKAGES/$REPOS_DIR/bin/windows/contrib/2.7"
