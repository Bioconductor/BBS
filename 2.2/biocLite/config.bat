@rem ============================================================================
@rem Settings shared by all the Windows nodes involved in the 2.2-biocLite builds
@rem ============================================================================
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-2.2-biocLite/MEAT0
...
set BBS_BIOC_MANIFEST_FILE=%BBS_HOME%\2.2\biocLite\biocLite_2.2.manifest
