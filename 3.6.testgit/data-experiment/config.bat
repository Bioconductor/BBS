@rem ===================================================================================
@rem Settings shared by all the Windows nodes involved in the 3.6.testgit-data-experiment builds
@rem ===================================================================================
...
@rem set BBS_BIOC_MANIFEST_FILE=bioc-data-experiment.3.6.manifest
...
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.6.testgit-data-experiment/MEAT0
