#!/bin/bash
# ================================================================
# Settings shared by all the Unix nodes involved in the 3.6.testgit builds
# ================================================================
...
export BBS_BIOC_VERSION="3.6"
export BBS_BIOC_GIT_BRANCH="master"
export BBS_BIOC_VERSIONED_REPO_PATH="${BBS_BIOC_VERSION}.testgit/$BBS_MODE"
