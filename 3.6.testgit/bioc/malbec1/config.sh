...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.6.testgit-bioc"
...
export BBS_OUTGOING_MAP="source:malbec1/buildsrc win.binary:tokay1/buildbin mac.binary.el-capitan:veracruz1/buildbin"
...
export BBS_REPORT_NODES="malbec1 tokay1:bin veracruz1:bin"
