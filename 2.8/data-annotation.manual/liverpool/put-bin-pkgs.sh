...
# put-bin-pkgs.sh
#
# Put the "2.8-data-annotation" binary packages on lamb1.
...
REPOS_LABEL="2.8-data-annotation"
REPOS_DIR="2.8/data/annotation"

SRC_DIR="/cygdrive/e/biocbld/bbs-2.8-data-annotation/bin-pkgs"

DEST_HOST="lamb1"
DEST_USER="biocadmin"
DEST_DIR="PACKAGES/$REPOS_DIR/bin/windows/contrib/2.13"
