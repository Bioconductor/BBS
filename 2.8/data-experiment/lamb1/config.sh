...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.8-data-experiment"
export BBS_R_HOME="/home/biocbuild/bbs-2.8-bioc/R"
export BBS_NB_CPU=2
...
export BBS_OUTGOING_MAP="source:lamb1/buildsrc win.binary:gewurz/buildbin mac.binary.leopard:pelham/buildbin"
...
export BBS_REPORT_NODES="lamb1 gewurz:bin pelham:bin"
