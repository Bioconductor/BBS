...
export BBS_NODE_HOSTNAME="bbscentral3"
...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo2/buildsrc mac.binary.big-sur-arm64:kjohnson3/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo2 kjohnson3:buildbin"
