#!/bin/bash
# ================================================================================
# Settings shared by all the Unix nodes involved in the 3.24-bioc-longtests builds
# ================================================================================
...
export BBS_BIOC_MANIFEST_CLONE_PATH="/home/biocbuild/bbs-3.24-bioc/manifest"
...
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.24-bioc/MEAT0"
