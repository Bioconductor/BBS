...
export BBS_NB_CPU=2
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.3-data-experiment"
export BBS_R_HOME="/home/biocbuild/bbs-2.3-bioc/R"
...
export BBS_REPORT_NODES="wilson1 liverpool:bin pitt:bin"
