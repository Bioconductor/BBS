...
export BBS_NB_CPU=2
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-2.3-bioc"
...
export BBS_REPORT_NODES="wilson2 wilson1 gewurz:bin pitt:bin pelham:bin"
export BBS_SVNCHANGELOG_URL="http://fgc.lsi.umich.edu/cgi-bin/blosxom2.cgi"
