...
BBS_CENTRAL_RDIR="/home/biocbuild/public_html/BBS/2.5/data-experiment"

REPOS_ROOT="$HOME/PACKAGES/2.5/data/experiment"
SRC_CONTRIB="$REPOS_ROOT/src/contrib"
WIN_CONTRIB="$REPOS_ROOT/bin/windows/contrib/2.10"
MAC_UNIVERSAL_CONTRIB="$REPOS_ROOT/bin/macosx/universal/contrib/2.10"
MAC_LEOPARD_CONTRIB="$REPOS_ROOT/bin/macosx/leopard/contrib/2.10"
