...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.6/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.6/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/3.4/*.zip bin/macosx/contrib/3.4/*.tgz"
CONTRIB_DIR=" \/.*\/"
