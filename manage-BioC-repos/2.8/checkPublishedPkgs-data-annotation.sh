...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.8/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.8/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.13/*.zip bin/macosx/leopard/contrib/2.13/*.tgz"
CONTRIB_DIR=" \/.*\/"
