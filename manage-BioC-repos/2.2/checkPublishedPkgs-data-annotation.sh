...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.2/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.2/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.7/*.zip bin/macosx/universal/contrib/2.7/*.tgz"
CONTRIB_DIR=" \/.*\/"
