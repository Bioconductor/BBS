...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.14/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.14/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/3.1/*.zip bin/macosx/contrib/3.1/*.tgz"
CONTRIB_DIR=" \/.*\/"
