...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.12/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.12/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/2.16/*.zip bin/macosx/contrib/2.16/*.tgz"
CONTRIB_DIR=" \/.*\/"
