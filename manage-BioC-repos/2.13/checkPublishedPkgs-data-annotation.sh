...
LOCAL_REPO_ROOT="$HOME/PACKAGES/2.13/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/2.13/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/3.0/*.zip bin/macosx/contrib/3.0/*.tgz"
CONTRIB_DIR=" \/.*\/"
