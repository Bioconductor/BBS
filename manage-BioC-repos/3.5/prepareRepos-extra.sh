...
CONTRIB_PATHS="c('source'='src/contrib', 'win.binary'='bin/windows/contrib/$R_VERSION', 'mac.binary.mavericks'='bin/macosx/mavericks/contrib/$R_VERSION', 'mac.binary.el-capitan'='bin/macosx/el-capitan/contrib/$R_VERSION')"
LOG_URL=""
