...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.7/data/experiment"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.7/data/experiment"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/3.5/*.zip bin/macosx/contrib/3.5/*.tgz"
CONTRIB_DIR=" \/.*\/"
