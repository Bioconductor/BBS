...
export BBS_OUTGOING_MAP="source:linux1.bioconductor.org/buildsrc win.binary:moscato1/buildbin mac.binary:perceval/buildbin"
...
export BBS_REPORT_NODES="linux1.bioconductor.org moscato1:bin perceval:bin"
