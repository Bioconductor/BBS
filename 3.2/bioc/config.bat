@rem ========================================================================
@rem Settings shared by all the Windows nodes involved in the 3.2-bioc builds
@rem ========================================================================
...
@rem Where is it?
set BBS_MEAT0_RHOST=linux1
set BBS_MEAT0_RUSER=biocbuild
set BBS_MEAT0_RDIR=/home/biocbuild/bbs-3.2-bioc/MEAT0
