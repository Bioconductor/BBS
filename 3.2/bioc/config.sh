#!/bin/bash
# =====================================================================
# Settings shared by all the Unix nodes involved in the 3.2-bioc builds
# =====================================================================


export BBS_MODE="bioc"

export BBS_BIOC_MANIFEST_FILE="bioc_3.2.manifest"
...
# Where is it?
export BBS_MEAT0_RHOST="linux1"
export BBS_MEAT0_RUSER="biocbuild"
export BBS_MEAT0_RDIR="/home/biocbuild/bbs-3.2-bioc/MEAT0"
