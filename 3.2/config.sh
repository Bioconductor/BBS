#!/bin/bash
# ================================================================
# Settings shared by all the Unix nodes involved in the 3.2 builds
# ================================================================
