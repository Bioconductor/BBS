...
export BBS_NB_CPU=9         # 20 cores are available
export BBS_CHECK_NB_CPU=12  # 20 cores are available
...
export BBS_REPORT_NODES="malbec1 nebbiolo1 tokay1:bin riesling1:bin merida1:bin"
