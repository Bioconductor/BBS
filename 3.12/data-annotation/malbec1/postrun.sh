...
$BBS_RSCRIPT_CMD --vanilla -e "source('$BBS_HOME/utils/createPropagationDB.R');createPropagationList('$OUTGOING_DIR', '$PROPAGATION_STATUS_DB', 'data/annotation', '$INTERNAL_REPOS')"
